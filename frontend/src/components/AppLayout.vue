...
const menuGroupsRaw = [
  {
    ...
    items: [
      ...
      { path: '/weighing-history/classic', labelKey: 'layout.menuWeighingHistoryClassic', icon: 'scale', adminOnly: true },
...
const currentRouteName = computed(() => {
  const nameMap: Record<string, string> = {
    ...
    '/weighing-history/classic': t('layout.routeNames.weighingHistoryClassic'),
